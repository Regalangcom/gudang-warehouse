                ...
                <div class="card-body">
                    <div class="text-center chat-image mb-5">
                        <div class="avatar avatar-xxl chat-profile mb-3 brround">
                            ...
                            <img src="{{url('/assets/default/users/undraw_profile.svg')}}" alt="profile-user" id="profileImage" class="avatar-img rounded-circle">
                            @else
                            <img src="{{asset('storage/users/'.$data->user_foto)}}?v={{time()}}" alt="profile-user" id="profileImage" class="avatar-img rounded-circle w-100 h-100 object-fit-cover">
                            @endif
                        </div>
